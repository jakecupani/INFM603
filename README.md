...
The website consists of HTML code for site foundation and Bootstrap for site stylings and design. The site also consists of Python code used in the Django web framework to create the Home, Quizzes, and About pages. For quiz questions, a SQL data store was used. Python and Django were used to create quizzes based on the user selection of topic(s) and difficulty level.
...
The project team used images from the following sources:
 ...
 -[w3schools](https://www.w3schools.com/css/default.asp) for styling and design
